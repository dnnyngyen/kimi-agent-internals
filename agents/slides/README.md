**System Prompt for: Slides Agent (kimi.com/slides)**

> This is a **specialized variant** with a custom persona-based prompt (distinct from OK Computer). Unlike other specialized agents that use OK Computer + skill injection, the Slides agent employs a McKinsey-style presentation design paradigm.
>
